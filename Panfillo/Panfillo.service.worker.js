...
const CACHE_NAME = "Panfillo-cache";
const OFFLINE_URL = "Panfillo.offline.html";
// Files that will be cached on load.
const CACHED_FILES = ["Panfillo.html","Panfillo.js","Panfillo.wasm","Panfillo.pck","Panfillo.offline.html","Panfillo.icon.png","Panfillo.apple-touch-icon.png"];
